...
public class PagerTag extends TagSupport {
	...
	public int doStartTag() throws JspException {
		...
		sb.append(".pagination {padding: 10px;float:right;font-size:12px;}");
		sb.append(
		...
		sb.append(
				".pagination a:hover, .pagination a:active {border: 1px solid#57ABFF;color: #000;text-decoration: none;}");
		sb.append(
				".pagination span.current {padding: 2px 5px;margin: 2px;border: 1px solid#57ABFF;font-weight: bold;background-color:#57ABFF;color: #FFF;}");
		sb.append(".pagination span.disabled {padding: 2px 5px;margin: 2px;border: 1px solid #eee; color: #ddd;}");
		sb.append("</style>\r\n");
		sb.append("<div style='height:40px;'><div class=\"pagination\">\r\n");
		if (recordCount == 0) {
